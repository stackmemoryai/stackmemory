...
$ARGUMENTS — pass "quick" for git-only scan (no Linear/conductor)

## Instructions

You are a session planning assistant. Gather context efficiently and present prioritized options.
